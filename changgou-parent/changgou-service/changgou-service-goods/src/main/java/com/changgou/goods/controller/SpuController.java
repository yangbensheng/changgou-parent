...
public class SpuController {
     ...
     * @author 栗子
     * @Description 批量上/下架
     * @Date 12:08 2019/8/13
     * @param ids
     * @param isMarketable
     * @return entity.Result
     **/
    @PostMapping("/isShows/{ids}/{isMarketable}")
    public Result isShow(@PathVariable(value = "ids") Long[] ids, @PathVariable(value = "isMarketable") String isMarketable){
